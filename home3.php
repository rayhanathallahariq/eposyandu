    ...
    <footer class="bg-light text-start">
      ...
      <div class="container p-2">
		...
		?> </h5>
          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            <br><br><br><br><br><br>
            <p class="text-dark text">© 2021 Copyright: Kokuri team, PT. Tristek Media Kreasindo | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'></a>
            </p>
          </div>
        </div>
      </div>
